package com.deanxd.javafix.core;

import android.content.Context;


import com.deanxd.javafix.utils.ArrayUtils;
import com.deanxd.javafix.utils.FileUitls;
import com.deanxd.javafix.utils.ReflectUtils;
...
public class FixDexUtils {
    ...
    public static boolean loadFixFile(Context context) {
        try {
            ...
            if (!fOpt.exists()) {
                if (!fOpt.mkdirs()) {
                    throw new RuntimeException(fOpt.getName() + " create error");
                }
            }
